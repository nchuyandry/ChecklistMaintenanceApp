...
<meta name="author" content="ICT Infra">
  ...
  <title>Standar Spesifikasi Hardware</title>
      ...
      <div id="content">
		...
		<div class="card shadow mb-4">
			<div class="card-header py-3">
				...
				Standar Spesifikasi PC Desktop
				</h4>
			</div>
			<div class="card-body">
				<div class="table-responsive">
					<img width="1000px" src="<?=base_url()?>assets/img/spekdesktop.jpg"/>
				</div>
			</div>
		</div>
		<div class="card shadow mb-4">
			<div class="card-header py-3">
				<h4 class="m-0 font-weight-bold text-primary">
				<lord-icon src="https://cdn.lordicon.com/amrlvyxr.json"trigger="loop" style="width:32px;height:32px"></lord-icon>
				Standar Spesifikasi Laptop
				</h4>
			</div>
			<div class="card-body">
				<div class="table-responsive">
					<img width="1000px" src="<?=base_url()?>assets/img/speklaptop.jpg"/>
				</div>
			</div>
		</div>
	</div>
